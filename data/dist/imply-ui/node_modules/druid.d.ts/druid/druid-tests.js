...
let timeBoundaryQuery = {
    "queryType": "timeBoundary",
    "dataSource": "sample_datasource",
    "bound": "maxTime"
};
let timeBoundaryResults = [
    {
...
let regexFilteredDimensionSpec = {
    "type": "regexFiltered",
    "delegate": "tags",
    "pattern": "a+"
};
...
let namespaceExtractionFn = {
    "type": "lookup",
    "lookup": { "type": "namespace", "namespace": "some_lookup" },
    "replaceMissingValueWith": "Unknown",
    "injective": false
};
let substrExtractionFn = {
    "type": "substring",
    "index": 1,
    "length": 4
};
let regexExtractionFn = {
    type: "regex",
    expr: "^(.)",
    "replaceMissingValue": true,
    "replaceMissingValueWith": "foobar"
};
let cascadeExtractionFn = {
    "type": "cascade",
    "extractionFns": [
        {
            "type": "regex",
...
let stringFormatExtractionFn = {
    "type": "stringFormat",
    "format": "[%s]",
    "nullHandling": "returnNull"
};
let registeredLookupExtractionFn = {
...
let bucketExtractionFn = {
    "type": "bucket",
    "size": 5,
    "offset": 2
};
let cardinalityAggregation = {
    "type": "cardinality",
