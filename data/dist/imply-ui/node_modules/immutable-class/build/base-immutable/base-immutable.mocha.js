...
describe("BaseImmutable", function () {
    ...
    describe('deepChange', function () {
        ...
        it('works with default value for an immutable property', function () {
            var car = car_mock_1.Car.fromJS({ fuel: 'electric', name: 'ford' });
            var newCar = car.deepChange('driver.name', 'mlem');
            chai_1.expect(newCar.deepGet('driver.name')).to.equal('mlem');
        });
    });
    ...
    it("works with emptyArrayIsOk", function () {
        var car = car_mock_1.Car.fromJS({
            fuel: 'electric',
            name: 'ford',
            owners: []
