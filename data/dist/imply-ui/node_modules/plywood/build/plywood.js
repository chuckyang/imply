...
var version = exports.version = '0.17.26';
...
var Expression = (function () {
    ...
    Expression.prototype._computeResolvedSimulate = function (options, simulatedQueryGroups) {
        var _a = options.maxComputeCycles, maxComputeCycles = _a === void 0 ? 5 : _a, _b = options.maxQueries, maxQueries = _b === void 0 ? 500 : _b, maxRows = options.maxRows;
        var ex = this;
    ...
    Expression.prototype._computeResolved = function (options) {
        var rawQueries = options.rawQueries, _a = options.maxComputeCycles, maxComputeCycles = _a === void 0 ? 5 : _a, _b = options.maxQueries, maxQueries = _b === void 0 ? 500 : _b, maxRows = options.maxRows;
        var ex = this;
        var readyExternals = ex.getReadyExternals();
        var computeCycles = 0;
        var queriesMade = 0;
                ...
                switch (columnData.type) {
                    ...
                    case 'LONG':
                        attributes.push(new AttributeInfo({
                            ...
                            type: 'NUMBER',
                            nativeType: nativeType,
                            unsplitable: !(numericColumnSupport && !hasOwnProp(aggregators, name_2)),
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(depth !== 'shallow' && attributes.length && attributes[0].nativeType === '__time' && !attributes[0].range)) return [3, 3];
                        query = {
                            queryType: "timeBoundary",
                            dataSource: this.getDruidDataSource()
                        };
